            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-slate-300">
                  ...
                  validate contracts, and prepare clean items for board approval
              ...
              <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-400">
                    Demo invoices awaiting manager verification.
                  </p>
                </div>
                  ...
                  >
                    <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-start">
                      <div>
                        ...
                        <p className="mt-3 text-lg font-semibold text-[#F3D77A]">
                          {item.amount}
                        </p>
            ...
            <aside className="space-y-6">
              <div className="rounded-[2rem] border border-[#D4AF37]/20 bg-[#D4AF37]/10 p-6 shadow-2xl">
                ...
                <div className="mt-5 space-y-3 text-sm text-slate-200">
                  ...
                  <p>3. Verify amount and frequency.</p>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 shadow-2xl backdrop-blur-xl">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-400">
                  Proper invoice review prevents overpayment, ensures accountability,
                  and provides the board with clear, decision-ready financial items.
                </p>
              </div>
            </aside>
          </div>
