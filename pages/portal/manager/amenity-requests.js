...
const requests = [
  {
    ...
    date: "May 18, 2026",
    status: "Needs Review",
    next: "Confirm date availability and deposit requirement.",
  },
  {
    id: "AMN-018",
    amenity: "Pool Cabana",
    ...
    next: "Verify guest policy acknowledgment.",
  },
  {
    id: "AMN-019",
    ...
    next: "Review overlapping calendar reservation.",
  },
];

export default function ManagerAmenityRequests() {
            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
              <div>
                <div className="mb-4 inline-flex rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-4 py-2 text-sm font-medium text-[#F3D77A]">
                  Amenity Request Review
                </div>

                <h1 className="text-3xl font-semibold tracking-tight sm:text-5xl">
                  Manage reservations before confirmation.
                </h1>

                <p className="mt-4 max-w-3xl text-slate-300">
                  Review amenity requests, check availability, verify deposits,
                  confirm rules, and approve or return requests to the owner.
                </p>
              </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.55fr_0.9fr]">
            <section className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 shadow-2xl backdrop-blur-xl">
              <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                  <h2 className="text-2xl font-semibold">Amenity Review Queue</h2>
                  <p className="mt-2 text-sm text-slate-400">
                    Demo amenity requests waiting for manager review.
                  </p>
                </div>
                    ...
                    <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-start">
                      <div>
                        ...
                        <h3 className="mt-4 text-xl font-semibold">
                          {item.amenity} Reservation
                        </h3>

                        <p className="mt-2 text-sm text-slate-400">
                          {item.owner} · Requested Date: {item.date}
                        </p>
            ...
            <aside className="space-y-6">
              <div className="rounded-[2rem] border border-[#D4AF37]/20 bg-[#D4AF37]/10 p-6 shadow-2xl">
                <h2 className="text-xl font-semibold text-[#F3D77A]">
                  Amenity Review Standard
                </h2>
                <div className="mt-5 space-y-3 text-sm text-slate-200">
                  <p>1. Confirm requested date and time.</p>
                  <p>2. Check for calendar conflicts.</p>
                  <p>3. Verify deposits and guest rules.</p>
                  <p>4. Confirm approval or return for correction.</p>
                </div>
              </div>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 shadow-2xl backdrop-blur-xl">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-400">
                  Amenity requests should not live in emails or text messages.
                  BOS keeps reservations organized, reviewed, and documented.
                </p>
              </div>
            </aside>
          </div>
