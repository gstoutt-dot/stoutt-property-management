                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-3 flex flex-wrap gap-2">
                      <span className={`rounded-full border px-3 py-1 text-xs font-medium ${statusStyles[item.status] || 'border-white/10 bg-white/10 text-slate-300'}`}>
                        {String(item.status || 'open').replace('_', ' ')}
                      </span>

                      <span className={`rounded-full border px-3 py-1 text-xs font-medium ${priorityStyles[item.priority] || 'border-white/10 bg-white/10 text-slate-300'}`}>
                    ...
                    <div className="mt-4 grid gap-3 text-sm text-slate-400 md:grid-cols-3">
                      <div className="rounded-xl border border-white/10 bg-black/20 p-3">
                        ...
                        <div className="mt-1 text-slate-300">{item.source || 'Ava / Portal'}</div>
                      </div>
