      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-slate-400">
              Review, prioritize, route, and execute requests before escalation to Board, vendors, or owner updates.
            </p>
          </div>

          <button
            onClick={fetchData}
            className="rounded-xl border border-yellow-400/30 bg-yellow-400/10 px-5 py-3 text-sm font-medium text-yellow-300 shadow-lg transition hover:bg-yellow-400/20"
          >
            Refresh Live Data
          </button>
        </div>
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] shadow-2xl">
          ...
          <div className="divide-y divide-white/10">
            ...
            {!loading &&
              filtered.map((item) => (
                <div key={item.id} className="px-6 py-6 hover:bg-white/[0.03] transition">
                  <div className="flex flex-col gap-5 lg:flex-row lg:justify-between">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 grid gap-3 md:grid-cols-3 text-sm">
                        <div className="p-3 border border-white/10 rounded-xl bg-black/20">
                          <div className="text-xs text-slate-500">Source</div>
                          <div>{item.source || 'Ava / Portal'}</div>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-2 lg:w-64 lg:justify-end">
                      <button
                        ...
                        className="px-4 py-2 text-sm rounded-xl border border-white/10 bg-white/5 hover:bg-white/10"
                      >
                        Reopen
                      </button>
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-sm rounded-xl border border-yellow-400/30 bg-yellow-400/10 text-yellow-300 hover:bg-yellow-400/20"
                      >
                        Start
                      </button>
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-sm rounded-xl border border-emerald-400/30 bg-emerald-400/10 text-emerald-300 hover:bg-emerald-400/20"
                      >
                        Complete
                      </button>
                    </div>
