...
export default function OwnerDocuments() {
  ...
  async function loadOwnerProfile() {
    try {
      ...
      console.error("Owner documents profile load failed:", error);
      router.replace("/portal/owner/login");
    }
  ...
  const documents = [
    ...
    },
    {
      ...
      category: "Owner Forms",
      status: "Available",
    },
    {
      id: "DOC-003",
      title: "Financial Statements and Notices",
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="rounded-3xl border border-yellow-400/20 bg-yellow-400/[0.06] p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
            Secure owner document area for governing documents, forms,
            statements, notices, and future association document access.
          </p>
