            ...
            <div className="max-w-5xl">
              <div className="flex flex-col items-start">
                <div className="inline-flex rounded-full border border-yellow-400/30 bg-yellow-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-yellow-300">
                  Board Resources • Workshops • Director Training
                </div>

                <p className="mt-4 text-sm font-medium leading-6 tracking-[0.08em] text-yellow-100/85">
                  Practical education for stronger board leadership.
                </p>
              </div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-white/72">
                Stoutt Property Management helps HOA and condominium board
                members understand their responsibilities, improve
                decision-making, and lead their communities with greater
                confidence.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl rounded-3xl border border-yellow-400/20 bg-yellow-400/10 p-8 sm:p-10">
              <div className="text-sm font-semibold uppercase tracking-[0.22em] text-yellow-300">
                Designed for real board challenges
              </div>

              <h2 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">
                Practical workshops, not generic lectures.
              </h2>

              <p className="mt-5 text-lg leading-8 text-white/75">
                These workshops are designed around the real-world issues
                association boards face: slow responses, unclear
                responsibilities, compliance pressure, owner concerns,
