      ...
      <section className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <div className="rounded-3xl border border-amber-400/20 bg-gradient-to-br from-slate-900 to-slate-950 p-6 shadow-2xl md:p-8">
          ...
          <h2 className="mt-3 text-3xl font-semibold md:text-4xl">
            Monthly Financial Reporting Center
          </h2>

          <p className="mt-4 max-w-3xl text-slate-300">
            Monthly accounting reports synchronized from QuickBooks for recurring
            board review, operational oversight, and financial transparency.
          </p>
        </div>
