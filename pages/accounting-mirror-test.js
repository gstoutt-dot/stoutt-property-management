      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="mb-10">
          ...
          <p className="mt-4 max-w-4xl text-lg leading-8 text-slate-400">
            This simulates controlled accounting synchronization
            between QuickBooks and the secure owner accounting mirror layer.
          </p>
        </div>
          ...
          <>
            ...
            <div className="mt-8 rounded-3xl border border-emerald-400/20 bg-emerald-400/10 p-6">
              <h2 className="text-2xl font-semibold text-emerald-200">
                Controlled Accounting Mirror Active
              </h2>

              <p className="mt-4 max-w-4xl leading-8 text-slate-300">
                The platform now supports secure accounting
                visibility through mirrored owner balance data
                without exposing direct QuickBooks internals
                to portals, Ava, or operational workflows.
              </p>
            </div>
          </>
        )}
