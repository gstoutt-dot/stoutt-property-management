            ...
            <div className="flex flex-col justify-between border-r border-white/10 bg-white/[0.025] p-8 sm:p-12">
              <div>
                ...
                <h1 className="max-w-xl text-4xl font-semibold tracking-tight sm:text-5xl">
                  Board oversight, organized in one command center.
                </h1>

                <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
                  Review action items, maintenance activity, violations,
                  architectural approvals, reports, documents, and community
                  priorities with clear visibility.
                </p>
              </div>

              <div className="mt-12 space-y-4">
                {[
                  "Board action items and pending approvals",
                  "Maintenance and violation review queues",
                  "Architectural request oversight",
                  "Reports, documents, calendar, and community updates",
                ].map((item) => (
            ...
            <div className="flex items-center justify-center p-8 sm:p-12">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  Access the board dashboard and review community operations in real time.
                </p>
                ...
                <div className="mt-8 rounded-2xl border border-[#D4AF37]/20 bg-[#D4AF37]/10 p-4 text-sm leading-6 text-[#F3D77A]">
                  Demo mode: This routes directly into the Board Dashboard for presentation purposes.
                </div>
