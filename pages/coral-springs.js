...
export default function CoralSprings() {
  const reasonsForChange = [
    "Slow response times to boards and residents",
    "Missed property follow-up and inspection issues",
    "Weak collections consistency",
    "Poor vendor coordination",
    "High turnover at larger management companies",
    "Lack of real board relationship-building",
  ];
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <ul className="mt-6 space-y-4 text-sm leading-7 text-white/75">
                  <li className="border-b border-white/10 pb-4">
                    Built for communities that value responsiveness and accountability
                  </li>
                  <li className="border-b border-white/10 pb-4">
                    Focused on stronger operations and financial control
                  </li>
                  <li className="border-b border-white/10 pb-4">
                    Designed for boards seeking better communication and oversight
                  </li>
                  <li>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-8">
              ...
              <p className="mb-4 leading-8 text-white/70">
                Many boards are not looking for change just to make change.
                They start looking because too many important things begin
                slipping at the same time. Communication slows down.
                Follow-up becomes inconsistent. Collections lose momentum.
                Small issues stay unresolved too long and eventually become
                larger, more expensive problems.
              </p>
              <p className="leading-8 text-white/70">
                When that starts happening, boards want a company that is
                present, organized, accountable, and proactive.
              </p>
            </div>
        ...
        <section className="border-y border-white/10 bg-white/[0.03] py-16 sm:py-20 lg:py-24">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-8">
              ...
              <p className="mb-4 leading-8 text-white/70">
                Stoutt Property Management is built around experience,
                intelligent systems, and proactive execution. We believe
                communities perform better when the board has responsive
                support, clear communication, operational consistency, and a
                management company that sees issues early instead of reacting late.
              </p>
              <p className="leading-8 text-white/70">
                Our goal is simple: help your association operate more
                smoothly, protect the property, improve responsiveness, and
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[2rem] border border-yellow-400/20 bg-yellow-400/10 p-10 text-center">
              ...
              <p className="mx-auto mb-8 max-w-2xl leading-8 text-white/75">
                We can evaluate your current structure, identify weak points,
                and show you what a stronger management approach can look like.
              </p>
