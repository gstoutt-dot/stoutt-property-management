...
export default function CommandCenter() {
  ...
  const commandMetrics = [
    ...
    },
    {
      ...
      value: legalSignals.length,
      detail: "Potential counsel review",
    },
    {
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-3xl border border-amber-400/20 bg-gradient-to-br from-slate-900 to-slate-950 p-8 shadow-2xl">
          ...
          <h2 className="mt-3 text-4xl font-semibold tracking-tight">
            The Command Center is now reading the full BOS signal layer.
          </h2>

          <p className="mt-4 max-w-3xl text-slate-300">
            This page now aggregates legal, financial, operational, and
            high-risk governance signals from the same shared BOS data model
            powering the Performance Dashboard and Workflow Engine.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          <div className="rounded-3xl border border-red-400/20 bg-red-500/10 p-6">
            ...
            <p className="mt-2 text-sm text-red-100/70">
              Items requiring immediate executive visibility.
            </p>
          ...
          <div className="rounded-3xl border border-amber-400/20 bg-amber-400/10 p-6">
            ...
            <p className="mt-2 text-sm text-amber-100/70">
              Governance items that may affect board exposure or budget control.
            </p>
          ...
          <div className="rounded-3xl border border-sky-400/20 bg-sky-500/10 p-6">
            ...
            <p className="mt-2 text-sm text-sky-100/70">
              Maintenance and service-related matters that affect community
              performance.
            </p>
        ...
        <div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <p className="mt-2 text-sm text-slate-400">
            One executive view across all connected modules.
          </p>
        ...
        <div className="mt-10 rounded-3xl border border-amber-400/20 bg-amber-400/10 p-6">
          ...
          <p className="mt-3 text-slate-300">
            Command Center is now connected to the same shared BOS data layer as
            Performance Dashboard and Workflow Engine. The first operating loop
            is now active.
          </p>
        </div>
      </section>
