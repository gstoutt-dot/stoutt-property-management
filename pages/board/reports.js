...
export default function BoardReports() {
  const reports = [
    {
      ...
      period: "April 2026",
      notes:
        "Summary of financials, violations, maintenance, ARC activity, owner escalations, and open action items.",
    },
    {
      ...
      period: "April 2026",
      notes:
        "Current delinquent accounts, aging totals, payment activity, and recommended next-step collection actions.",
    },
    {
      title: "AI Call Activity Summary",
      type: "AI Analytics",
      status: "Reviewed",
      period: "Last 30 Days",
      notes:
        "Summary of owner calls, common questions, work orders created, escalations logged, and response trends.",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="max-w-3xl py-16">
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-6xl">
              Clear reporting for board oversight and better decisions.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Review financial reports, delinquency summaries, violation trends,
              maintenance activity, vendor performance, monthly management reports,
              and AI call analytics.
            </p>
      ...
      <section id="reports" className="mx-auto max-w-7xl px-6 pb-20">
        ...
        <div className="grid gap-5">
          {reports.map((report) => (
            <article
              key={`${report.title}-${report.period}`}
              className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20"
            >
