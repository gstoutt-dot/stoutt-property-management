...
export default function BoardReserves() {
  const reserveItems = [
    {
      component: "Roof Replacement",
      category: "Building",
      balance: "$185,000",
      usefulLife: "8 Years Remaining",
      status: "On Track",
      notes:
        "Reserve funding appears aligned with projected roof replacement schedule based on current contribution assumptions.",
    },
    {
      component: "Pool Resurfacing",
      category: "Recreation",
      balance: "$42,500",
      usefulLife: "3 Years Remaining",
      status: "Monitor",
      notes:
        "Pool resurfacing is approaching planning window. Board should review updated pricing and reserve allocation.",
    },
    {
      component: "Roadway & Asphalt",
      category: "Infrastructure",
      balance: "$96,750",
      usefulLife: "5 Years Remaining",
      status: "Review Needed",
      notes:
        "Roadway component may require updated cost estimate due to material and labor increases.",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="max-w-3xl py-16">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-yellow-300">
              Reserve Planning Center
            </p>

            <h1 className="text-4xl font-bold tracking-tight md:text-6xl">
              Long-term reserve planning for stronger asset protection.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Track reserve balances, component schedules, useful life estimates,
              funding projections, reserve study summaries, and major capital planning
              in one board-facing dashboard.
            </p>
      ...
      <section id="reserves" className="mx-auto max-w-7xl px-6 pb-20">
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-yellow-300">
              Reserve Components
            </p>
            <h2 className="mt-2 text-3xl font-bold">Board Reserve Planning</h2>
          </div>
              ...
              <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-start">
                <div>
                  <div className="flex flex-wrap items-center gap-3">
                    <h3 className="text-2xl font-semibold">{item.component}</h3>
                  ...
                  <div className="mt-3 grid gap-2 text-sm text-slate-300 md:grid-cols-3">
                    <p>
                      <span className="text-slate-500">Allocated Balance:</span>{" "}
                      {item.balance}
                    </p>
                    <p>
