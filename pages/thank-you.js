        ...
        {mobileOpen && (
          <div className="border-t border-white/10 bg-slate-950/95 backdrop-blur-xl lg:hidden">
            <div className="mx-auto flex max-w-7xl flex-col gap-2 px-5 py-4 sm:px-6">
              ...
              <a
                href="/proposal"
                className="mt-2 rounded-full border border-yellow-400/30 bg-gradient-to-r from-yellow-300 to-amber-400 px-5 py-3 text-center text-sm font-semibold text-slate-950 shadow-[0_0_30px_rgba(234,179,8,0.2)] transition-all duration-300"
                onClick={() => setMobileOpen(false)}
              >
                Request a Proposal
              </a>
  ...
  <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/70 sm:text-lg">
    ...
    needs.
                  ...
                  <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <a
                      href="https://calendly.com/bosaisoftware/30min"
