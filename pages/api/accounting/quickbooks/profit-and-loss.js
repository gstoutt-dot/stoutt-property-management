...
export default async function handler(req, res) {
  ...
  try {
    ...
    const quickBooksUrl = `${getQuickBooksBaseUrl()}/v3/company/${realmId}/reports/ProfitAndLoss?${params.toString()}`;
    ...
    return res.status(200).json({
      ...
      report_period: reportJson?.Header?.ReportName || "Profit and Loss",
