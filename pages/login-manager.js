            ...
            <div className="flex flex-col justify-between border-r border-white/10 bg-white/[0.025] p-8 sm:p-12">
              <div>
                ...
                <h1 className="max-w-xl text-4xl font-semibold tracking-tight sm:text-5xl">
                  Review, verify, and route community requests before board action.
                </h1>

                <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
                  The manager portal is the operational review layer for violations,
                  work orders, architectural requests, vendor invoices, amenity requests,
                  and miscellaneous community items before they move to the board.
                </p>
              </div>

              <div className="mt-12 space-y-4">
                {[
                  "Initial intake review for all incoming requests",
                  "Verify details, photos, priority, and association responsibility",
                  "Approve, reject, inspect, or escalate to the board",
                  "Route vendor invoices and payment items for board approval",
                ].map((item) => (
            ...
            <div className="flex items-center justify-center p-8 sm:p-12">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  Access the manager review dashboard and process incoming community items.
                </p>
                ...
                <div className="mt-8 space-y-5">
                  <div>
                    ...
                    <input
                      type="email"
                      placeholder="manager@stouttpm.com"
                ...
                <div className="mt-8 rounded-2xl border border-[#D4AF37]/20 bg-[#D4AF37]/10 p-4 text-sm leading-6 text-[#F3D77A]">
                  Demo mode: This routes directly into the Property Manager review dashboard.
                </div>
